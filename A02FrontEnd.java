import javax.management.Query; import javax.swing.*; import java.awt.*; import java.awt.event.*; import java.sql.PreparedStatement; import java.sql.ResultSet; import java.sql.SQLException; import java.sql.SQLOutput; import java.text.*; import java.util.ArrayList; import java.util.List;
...
public class A02FrontEnd extends JFrame implements ItemListener, ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		A02MiddleTier util =  new A02MiddleTier();

		util.find(util,eventConference,eventJournal,eventBook,allDates,fromDate,toDate,queryOutput);
